# v1.0.2 (Tue May 31 2022)

#### 🐛 Bug Fix

- chore: added lerna example command (alfredbrockotter@frontis.nl)
- chore: changed lerna config (alfredbrockotter@frontis.nl)
- chore: re-added git tag as a plugin (alfredbrockotter@frontis.nl)
